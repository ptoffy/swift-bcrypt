...
///
/// Just like Blowfish, it starts off with a 576-bit state consisting of four S-boxes and a 32-bit P-array.
/// These are initialized with the hexadecimal digits of pi, and then modified by the key schedule.
/// The key schedule is the expensive part of the algorithm, and is designed to be slow to compute.
enum EksBlowfish {
